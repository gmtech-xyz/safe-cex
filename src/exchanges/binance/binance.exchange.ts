...
export class Binance extends BaseBinanceExchange {
  xhr: Axios;
  unlimitedXHR: Axios;
  ...
  listenOHLCV = (opts: OHLCVOptions, callback: (candle: Candle) => void) => {
    const ws = BASE_WS_URL.public[this.options.testnet ? 'testnet' : 'livenet'];
    return this._listenOHLCV(ws, opts, callback);
  };
